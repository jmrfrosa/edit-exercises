Vamos treinar algumas manipulações habituais em strings. Como este exercício requer algum input do utilizador, podemos utilizar a função `prompt` do browser:
